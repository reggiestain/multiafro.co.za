           ...
           <!-- <li class="treeview">
            ...
            <!--<li class="treeview" data-toggle="collapse" data-target="#">
             ...
             <?php if($user->user('user_group_id') == 1) {?>
              ...
              <ul class="treeview-menu">
                <li><a href="#<?php echo Cake\Routing\Router::url('/career3-d/mentors/list_progam');?>"><i class="fa fa-circle-o"></i> </a></li>
                <li><a href="#<?php echo Cake\Routing\Router::url('/career3-d/mentors/create_program');?>"><i class="fa fa-circle-o"></i> </a></li>
                <!--<li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>-->
              </ul>
            </li>  
            <li class="treeview">
